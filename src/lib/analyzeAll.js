...
const RUNNERS = {
  ...
  noise_profile:    (bb, cli, params) => analyzeNoiseProfile(bb, params),
  tpa:              (bb, cli, params) => analyzeTPA(bb, params),
  prop_wash:        (bb, cli, params) => analyzePropWash(bb, params),
  anti_gravity:     (bb, cli, params) => analyzeAntiGravity(bb, params),
  iterm:            (bb, cli, params) => analyzeITermBuildup(bb, params),
  ...
  pid_contribution: (bb, cli, params) => analyzePIDContribution(bb, params),
